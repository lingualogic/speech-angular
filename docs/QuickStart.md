# Speech-Angular Schnelleinstieg

In unserem Schnelleinstieg wollen wir eine Angluar App erstellen und sie um Sprachdienste erweitern. Den Code findet ihre im /examples Ordner.
