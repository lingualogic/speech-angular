...
* 0.5.12.0028 Alpha vom 08.07.2019 [Release Notizen](./CHANGELOG.md)
...
Das im dist/ Ordner erzeugte npm-Paket 'speech-angular-0.5.12.tgz' kann in den eigenen Angular Projektordner kopiert werden.

Die Installation des 'speech-angular-0.5.12.tgz' npm-Paketes erfolgt im eigenen Angular Projektordner mit folgendem Befehl:

    $ npm install speech-angular-0.5.12.tgz
