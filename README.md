...
Clonen des Github-Repsitories unter [github.com/lingualogic/speech-angular](https://github.com/lingualogic/speech-angular): 
...
### Sprachausgaben
Im ersten Schritt wollen wir Sprachausgabe mittels [Sprachsynthese] (https://de.wikipedia.org/wiki/Sprachsynthese) realisert. 
...
Im Konstruktor des AppModules können Eigenschaften des Speaksservices mittels Optionen gesetzt werden. Für dieses Beispiel reichen uns die Defaultwerte. Weiteres zu Optionen [hier](./docs/api/interfaces/speech_speak.speakserviceoptioninterface.html). 

Nun steht der Service in unseren Componenten zur Verfügung. Wir wollen ihn in der AppComponent nutzen. 
Dafür öffen wir 'app.component.ts' und importieren den SpeakService. Im Konstruktor der Klasse erzeugen wir über Dependency Injection ein SpeakService Objekt. Die Funktionalität des Services kann [hier](./docs/api/classes/speech_speak.speakservice.html) nachgelesen werden.
...
Im zweiten Teil unserer Kurzanleitung, wollten wir an einem Beispiel zeigen, wie Speech-Angular die Entwicklung solcher Szenarien ermöglicht. Hierzu werden ActionService und BotService genutzt.
...
Um die Funktionalität auszuführen, überarbeiten wir die Template Datei 'app.component.html' wie folgt: 
	...
	<div style="text-align:center">
	  ...
	  <h2>This App can Speak and execute Actions simultaneous: </h2>
...
Dieser Wechsel soll nun per Link erfolgen. Daher passen wir die Template-Datei 'home.component.html' an. 
	...
	<a routerLink="/bot">Let the bot do that for you </a>
...
Hierzu verwenden wir [Events](./docs/api/classes/speech_bot.botservice.html) die uns der Botservice bereitstellt. Das Stopevent wird ausgegeben, wenn der Dialog für einem State ausgegeben wurde. Es wird in die 'ngOnInit' Funktion von 
