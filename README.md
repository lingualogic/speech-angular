...
* 0.5.11.0027 Alpha vom 25.06.2019 [Release Notizen](./CHANGELOG.md)
...
Das im dist/ Ordner erzeugte npm-Paket 'speech-angular-0.5.11.tgz' kann in den eigenen Angular Projektordner kopiert werden.

Die Installation des 'speech-angular-0.5.11.tgz' npm-Paketes erfolgt im eigenen Angular Projektordner mit folgendem Befehl:

    $ npm install speech-angular-0.5.11.tgz
